...
//cfg dosyasinin ismini yazıyorduk eğer yazmasanız hata vermez çünkü default olarak icerisine "hibernate.cfg.xml" yazar
        ...
        trs.commit();//gümrük tüm işlemleri onayladı geçiş serbest
        session.close();
